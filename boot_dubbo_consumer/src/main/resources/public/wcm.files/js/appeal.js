...
function loadSQFormUpload()
{
	...
	$("#uploadify").uploadify( {//初始化函数
		'uploader' :'/wcm.files/js/jquery-plugin/uploadFile/uploadify.swf',//flash文件位置，注意路径
		'script' :'/servlet/PeculiarUploadFile',//后台处理的请求
		'cancelImg' :'/wcm.files/js/jquery-plugin/uploadFile/cancel.png',//取消按钮图片
		'buttonImg': '/wcm.files/js/jquery-plugin/uploadFile/upst.gif',
